<?php
	...
	require_once dirname(__FILE__) . '/../wideimage/demo/helpers/common.php';
	require_once dirname(__FILE__) . '/../wideimage/lib/WideImage.php';
	
	$request = Request::getInstance();
	$demo = Demo::create($request->get('demo'));
	$image = WideImage::load($request->get('image'));
